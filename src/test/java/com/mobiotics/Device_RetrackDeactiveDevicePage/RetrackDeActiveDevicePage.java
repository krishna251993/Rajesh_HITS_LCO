package com.mobiotics.Device_RetrackDeactiveDevicePage;
...
public class RetrackDeActiveDevicePage extends BasePage{
	...
	static final Logger logger=Logger.getLogger(RetrackDeActiveDevicePage.class);
...
private String bulkRetrackFile=System.getProperty("user.dir")+"/ExcelPages/BulkRetrackDeactiveDevice.csv";
	...
	public void Retrack_DeactiveDevice_Bulk() {
	...
	public void ReTrack_DeActiveDevice_Single() throws InterruptedException {
		...
		for (int i = 1; i <= lastRow; i++) {
			...
			long custIDNum=DemoExcelLibrary3.getexcelDatanumber("modify customer", i, 14, dataPath);
